...
public_subnets_cidr                         = ["10.0.13.0/24", "10.0.14.0/24"]
private_subnets_cidr                        = ["10.0.15.0/24", "10.0.16.0/24"]
...
ssh_location = "10.0.48.0/24"

// Security group dynamic 
sg_ingress                  = [80, 443]

#RDS db subnet group
database_subnets = "techno_db_prod_subnets"
...
db_name              = "prod_Techno_db"
skip_final_snapshot  = true



#ALB Target groups
target_group_name          = "prod-techno-tgrp"
...
health_check_path          = "/"
load_balancer_name         = "p-techno-load-balancer"
...
#ECS
ecs_cluster_name = "prod-techno-cluster"
log_group_name   = "prod-techno-log-group"
ecs_family_name  = "prod-techno-tasks"
